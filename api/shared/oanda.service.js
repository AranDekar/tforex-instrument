        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (api.Config.settings.mockup_oanda) {
                ...
                return new Promise((resolve, reject) => {
                    this.client.getCandles(api.InstrumentEnum[instrument], start, end, api.GranularityEnum[granularity], (err, candles) => {
                        if (err) {
                            return reject(err);
                        }
...
exports.OandaService = OandaService;
/**
...
//# sourceMappingURL=oanda.service.js.map
